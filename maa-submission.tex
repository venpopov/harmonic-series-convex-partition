...
% The maa-monthly style already loads amsmath, amsthm, amsfonts, amssymb, graphicx, and url.
...
% =========================================================
% TITLE PAGE BLOCK 
% (Comment out this entire block for the Anonymized Manuscript)
% =========================================================
% \begin{center}
...
% \vspace{150px}
% \begin{center}
% \textbf{A Vertical Partition of the Harmonic Series} \\
% \vspace{25px}
...
\title{A Vertical Partition of the Harmonic Series}
\markright{Vertical Partition of the Harmonic Series}

% (Comment out the \author line for the Anonymized Manuscript)
...
\vspace{10px}
\noindent{\textbf{Keywords:} Harmonic series, convergence, convex denominators, telescoping sum, asymptotics.} 
\vspace{10px}
...
% =========================================================
% \begin{biog}
% \item[Ven Popov] [Insert a 2-3 sentence biography here.]
% \begin{affil}
% [Your Department/University], [Your City, State Zip] \\
% [Your Email]
% \end{affil}
% \end{biog}
% =========================================================
